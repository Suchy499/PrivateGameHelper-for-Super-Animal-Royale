...
class Settings(QWidget):
    def __init__(self, parent):
        ...
        self.content_layout.addWidget(self.ground_loot_label)
        self.content_layout.addWidget(self.ground_loot_settings)
        self.content_layout.addWidget(self.ground_loot_hline)
        self.content_layout.addSpacing(10)
        self.content_layout.addWidget(self.vehicles_label)
        self.content_layout.addWidget(self.vehicles_settings)
        self.content_layout.addWidget(self.vehicles_hline)
        self.content_layout.addSpacing(10)
        self.content_layout.addWidget(self.gas_label)
        self.content_layout.addWidget(self.gas_settings)
        self.content_layout.addWidget(self.gas_hline)
        self.content_layout.addSpacing(10)
        self.content_layout.addWidget(self.combat_label)
        self.content_layout.addWidget(self.combat_settings)
        self.content_layout.addWidget(self.combat_hline)
        self.content_layout.addSpacing(10)
        self.content_layout.addWidget(self.misc_label)
        self.content_layout.addWidget(self.misc_settings)
